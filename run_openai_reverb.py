...
AUDIO_DIR = "data/audio/processed/reverb"
OUTPUT_CSV = "benchmark_output/openai_reverb_results.csv"
...
def main():
    ...
    for _, row in df.iterrows():
        audio_file = row["path"].replace(".mp3", "_reverb.wav")
        reference_text = row["sentence"]
        condition = "reverb_echo"
